...
boolean  LSG_EEpromRW::eeprom_write_string(int addr, const char* string) {
...
boolean LSG_EEpromRW::write_StringEE(int Addr, String input)
{
...
boolean LSG_EEpromRW::eeprom_read_string(int addr, char* buffer, int bufSize) {
