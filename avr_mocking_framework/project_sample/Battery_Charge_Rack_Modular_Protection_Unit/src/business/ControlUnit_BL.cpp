...
#define HIGH 1
#define LOW 0
ControlUnit_BL::ControlUnit_BL(AvrMicroRepository& avrMicroRepository,AppConfig& app_config, 
	NTC3950thermistorActivity& thermistorActivity,DigitalPortActivity& relayActivity, AnalogPortCActivity& currentActivity)
	: avrMicroRepository(avrMicroRepository), app_config(app_config), thermistorActivity(thermistorActivity), 
